...
describe('Book API:', function() {
  ...
  describe('PUT /api/books/:id', function() {
    ...
    it('should respond with the original book', function() {
      updatedBook.name.should.equal('New Book');
      updatedBook.info.should.equal('This is the brand new book!!!');
    });
    ...
    it('should respond with the updated book on a subsequent GET', function(done) {
      request(app)
        ...
        .end((err, res) => {
          ...
          book.name.should.equal('Updated Book');
          book.info.should.equal('This is the updated book!!!');
  ...
  describe('PATCH /api/books/:id', function() {
    ...
    it('should respond with the patched book', function() {
      patchedBook.name.should.equal('Patched Book');
      patchedBook.info.should.equal('This is the patched book!!!');
    });
  });
