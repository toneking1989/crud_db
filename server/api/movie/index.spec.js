...
var movieCtrlStub = {
  ...
  upsert: 'movieCtrl.upsert',
  patch: 'movieCtrl.patch',
...
describe('Movie API Router:', function() {
  ...
  describe('PUT /api/movies/:id', function() {
    it('should route to movie.controller.upsert', function() {
      routerStub.put
        .withArgs('/:id', 'movieCtrl.upsert')
        .should.have.been.calledOnce;
    });
  });

  describe('PATCH /api/movies/:id', function() {
    it('should route to movie.controller.patch', function() {
      routerStub.patch
        .withArgs('/:id', 'movieCtrl.patch')
        .should.have.been.calledOnce;
    });
  });
